...
const (
	...
	CollectionLayoutGrid CollectionLayout = "grid"
	// CollectionLayoutList shows games as a list, with blurbs
	CollectionLayoutList CollectionLayout = "list"
)
...
type Bundle struct {
	...
	BundleGames []*BundleGame `json:"bundleGames,omitempty"`
}

// BundleGame represents a game's membership in a bundle.
type BundleGame struct {
	BundleID int64   `json:"bundleId" hades:"primary_key"`
